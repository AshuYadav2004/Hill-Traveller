...
const EnquireFormModal = () => {
    return (
        <div className="modal fade enquire_popup show" id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-modal="true" role="dialog" style={{ display: 'block', paddingLeft: '0px' }}>
